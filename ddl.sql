...
INSERT INTO user_roles (name) values ('Admin'), ('Pharmacy Admin'), ('Doctor'), ('User');
...
INSERT INTO shipping_methods (name) values ('Official Instant'), ('Official Same Day'), ('Non Official');
...
INSERT INTO manufacturers (name) values ('Soho Industri Pharmasi'), ('Amarox Pharma Global');
...
INSERT INTO product_categories (name) values ('Obat'), ('Non Obat');
...
INSERT INTO drug_classifications (name) values ('Obat Bebas'), ('Obat Keras'), ('Obat Bebas Terbatas'), ('Non Obat');
...
INSERT INTO product_stock_mutation_types (name) values ('Addition'), ('Deduction');
...
INSERT INTO product_stock_mutation_request_statuses (name) values ('Approved'), ('Canceled');
...
INSERT INTO consultation_session_statuses (name) values ('Open'), ('Close');
...
('Waiting for Payment'), ('Paid '), ('Waiting for Pharmacy'), ('Pharmacy Confirmed'), ('Order Packed'), ('Ready to Pickup'),
('Order Picked'), ('Order Sent'), ('Received'), ('Canceled');
